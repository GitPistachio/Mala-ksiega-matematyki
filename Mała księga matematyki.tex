...
\usepackage[left=2.5cm, right=2.5cm, top=2.5cm, bottom=2.5cm]{geometry} % ustawienia marginesów
...
\usepackage[type={CC}, modifier={by-nc-nd}, version={3.0}, lang={Polish}]{doclicense}
